      ...
      <div className="row d-flex">
        ...
        <div className="col-md-8">
          <div className="important-details">
            ...
            us through the Site and Application. This Privacy Policy may be
            updated from time to time. We may update this Privacy Policy to
            reflect changes to our information practices. If we make any
            material changes we will notify you by email (sent to the e-mail
            address specified in your letsdunch Account) or by means of a notice
            on the Site and Application prior to the change becoming effective.
            ...
            <br /> <br />
            As used in this policy, the terms “using” and “processing”
            ...
            among our affiliates internationally.
            <br />
            <br />
            Which information do we may collect? We may collect and process the
            following data about you: Information that you provide by filling in
            forms on our site <br />
            <br /> www.letsdunch.com (our site) and/or via a third party account
            (e.g. Facebook). This includes information provided at the time of
            registering to use our site, opening a host account, posting
            material, editing your profile, booking a meal or requesting further
            services, and includes but is not limited to your name, address,
            email address, phone number and if you are a user with meals to book
            (a Host), bank account or PayPal details, or if you are a user who
            wishes to book a meal (a Guest) and make a booking via our site,
            billing information. We may also ask you for information when you
            enter a competition or promotion sponsored by us, and when you
            report a problem with our site or a booking. If you contact us, we
            ...
            communication with you in order to check any instructions given to
            us, for training purposes, for crime prevention and to improve the
            quality of our customer service.
            <br />
            <br />
            <h5>1. IP Addresses</h5>
            ...
            system administration and to report aggregate information. This is
            ...
            <br />
            <br />
            <h5>4. Do we disclose any information to outside parties?</h5>
            ...
            advertising, or other uses. We may disclose your personal
            information to third parties: In the event that we sell or buy any
            ...
            letsdunch Limited or substantially all of its assets are acquired by
            a third party, in which case personal data held by it about its
            users will be one of the transferred assets. If we are under a duty
            to disclose or share your personal data in order to comply with any
            legal obligation, or in order to enforce or apply our Terms of Use
            and other agreements; or to protect the rights, property, or safety
            of letsdunch, our users, or others. This includes exchanging
            information with other companies and organisations for the purposes
            of fraud protection and credit risk reduction.
            <br />
            <br />
            <h5>5. Changing or Deleting Your Information</h5>
            All Members may review, update, correct or delete the Personal
            Information in their registration profile by contacting us at
            privacy@letsdunch.com or editing the relevant part of their profile.
            If you would like us to cancel your letsdunch Account, please
            contact us and we will attempt to accommodate your request if we do
            not have any legal obligation or a legitimate business reason to
            retain the information contained in your letsdunch Account. Please
            note that, if you cancel your letsdunch Account, any reviews you
            have posted via the Site and Application will remain publicly
            viewable via the Site and Application.
            <br />
            <br />
            ...
            <br />
            <br />
            <h5>7. Online Privacy Policy Only </h5>
            ...
            Any changes we may make to our privacy and cookies policy in the
            future will be posted on this page and, where appropriate, notified
            to you by email.
          </div>
        </div>
      </div>
